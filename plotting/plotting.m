...
%phase correction
f_x_ref = f_x_ref.*exp(j*2*pi*f*sqrt(mu_0*epsilon_0*e_eff)*(-6.6e-3));
f_x_1 = f_x_1.*exp(-j*2*pi*f*sqrt(mu_0*epsilon_0*e_eff)*(-8.6e-3));
f_x_2 = f_x_2.*exp(-j*2*pi*f*sqrt(mu_0*epsilon_0*e_eff)*(-8.9e-3));
f_x_3 = f_x_3.*exp(-j*2*pi*f*sqrt(mu_0*epsilon_0*e_eff)*(-8.9e-3));
